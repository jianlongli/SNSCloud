...
//		// Store variables
//		var accordion_a = $('.accordion li > .sub-menu > li > a');
//
...
//			var param = '/mnt/hgfs/www/SNSCloud/data/1/private/TEST/';
//			alert(param);
//			/*
//			$.ajax({
//				url:'index/pathList?this_path='+param,
//				dataType:'json',
//				beforeSend:function(){
...
//	});
	...
	var _f5 = function(is_data_server,is_animate,callback) {
		...
		if(!is_data_server){//采用当前数据刷新,用于显示模式更换
			...
			$.ajax({
				url:'index/pathList?this_path='+G.this_path,
				dataType:'json',
				beforeSend:function(){
					$('.tools-left .msg').stop(true,true).fadeIn(100);
				},
