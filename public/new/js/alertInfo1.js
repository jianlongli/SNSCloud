(function ($) {
    ...
    $.alertInfo = function (topInfo, cengerInfo, centerimg, width, height) {
        ...
        var sc="<div class='" + divs + "'><div class='divsalerttop' onMouseDown='$.alertdow(event);' onMouseUp='$.alertdup(event);'>" + topInfo + "<span><a href='#this' onclick='$.alertdel();'  style=' text-decoration:none;'>关闭</a></span></div><div class='divsalertcenter'> <iframe frameborder='no' src='" + url + "'></iframe></div></div>";
$("body").html($("body").html()+sc);
    ...
    function alertcss() {
        ...
        str += ".divsalerttop{border-bottom:1px solid #f3c1c1;width:" + alertwidth + "px;height:22px;padding-top:8px;cursor:move;}";
    ...
    $.alertUrl = function (url, topInfo, width, height) {
        ...
        $("<div class='hi" + divs + "'></div>").appendTo(info);
        $("<div class='" + divs + "'><div class='divsalerttop' onMouseDown='$.alertdow(event);' onMouseUp='$.alertdup(event);'>" + topInfo + "<span><a href='#this' onclick='$.alertdel();'  style=' text-decoration:none;'>关闭</a></span></div><div class='divsalertcenter'> <iframe frameborder='no' src='" + url + "'></iframe></div></div>").appendTo(info);
        alertwidth = width;
        alertheight = height;
        alerturlcss();
    }
