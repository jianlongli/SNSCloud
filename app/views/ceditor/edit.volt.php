...
?>
    ...
    <?php echo $this->tag->javascriptInclude('../../kindeditor-4.1.10/kindeditor-min.js'); ?>
    <?php echo $this->tag->javascriptInclude('../../kindeditor-4.1.10/lang/zh_CN.js'); ?>
	...
	<form name="example" method="post" action="/ceditor/filesave">
