...
<?php echo $this->tag->javascriptInclude('./eduis/js/zz.js'); ?>
			...
			<div class="frame-right-main">
				<div class="tools">
					<div class="tools-left">
						...
						<button id='zuoye' type="button" style='width: 92px; height: 29px; background: #e33658; border: 0px solid #e6e6e6; float: left;margin-right:20px;'>
					           <div style='width: 100%'>
					           <img style='margin-top: -3px;' src='../../../eduis/images/scw.png'>
					           <span style='font-size: 14px; font-weight: bold; color: #FFF; padding-left: 10px;'>作业</span></div>
					    </button>

					    <button id='myzuoye' type="button" style='width: 92px; height: 29px; background: #e33658; border: 0px solid #e6e6e6; float: left;margin-right:20px;'>
					           <div style='width: 100%'>
					           <img style='margin-top: -3px;' src='../../../eduis/images/scw.png'>
					           <span style='font-size: 14px; font-weight: bold; color: #FFF; padding-left: 10px;'>我的作业</span></div>
					    </button>
						    ...
						    <ul class="dropdown-menu pull-right drop-menu-action fadein">
							    ...
							    <i class="font-icon icon-info"></i>属性</a></li>
						    </ul>
						  </div>
						</div>
	...
	<div id='right_middle_button'>
		<input type="button" value="" class="wdq_btx22" onClick="javascript:manageCricle();" />
		<input type="button" value="" class="wdq_btx31" onclick="javascript:manageCricle();" />
		<input type="button" value="" class="wdq_btx11" onclick="javascript:manageCricle();" />
	</div>

<script src="<?php echo @$controllerName=='session' ? '../' : './'; ?>static/js/lib/seajs/sea.js"></script>
...
<script type="text/javascript">
	...
	var G = {
		...
		static_path : "<?php echo @$controllerName=='session' ? '../' : './' ?>static/",
		...
		this_path	: "<?php echo $this->session->get('gDiskPath'); ?>",//当前绝对路径
		myhome   	: "<?php echo $this->session->get('gDiskPath'); ?>",//当前绝对路径	
	...
	seajs.config({
		base: "<?php echo @$controllerName=='session' ? '../' : './' ?>static/js/",
...
<style type="text/css">
#right_middle_button { width:150px; height:auto; background:#F3F2F2; position:fixed; z-index:10; _position:absolute; right:0px; top:0px; padding: 5px 5px 5px 12px; float:left; }
.wdq_btx11 { background:url(../../JinSongSiXiao/imge/wdq_btx11.png) no-repeat top left; width:143px; height:40px; border:none; cursor:pointer; padding: }
.wdq_btx22 { background:url(../../JinSongSiXiao/imge/wdq_btx22.png) no-repeat top left; width:143px; height:40px; border:none; cursor:pointer; padding: }
.wdq_btx31 { background:url(../../JinSongSiXiao/imge/wdq_btx31.png) no-repeat top left; width:143px; height:40px; border:none; cursor:pointer; padding: }

</style>

<script type="text/javascript">
window.onscroll = window.onresize = window.onload = function() {
	var odiv = document.getElementById('right_middle_button');
...
function manageCricle() {

	var render = "<object style='border:0px' type='text/x-scriptlet' data='./demo/page/qshow.html' width='905px' height='568px' ></object>";
	
	var dialog = art.dialog({
			id:'alertManageCricle',
			fixed: true,//不跟随页面滚动
			icon:'',
			title: '管理圈子',
			padding:40,
