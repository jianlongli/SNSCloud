...
<?php echo $this->tag->javascriptInclude('./eduis/js/hover.js'); ?>
	...
	<div class="frame-main">
		<div class='frame-left'>
			<div class='GiLtop'><h2>我的G盘</h2></div>
			<!-- <ul id="folderList" class="ztree"></ul> -->
			<!--代码开始-->
            <div id="wrapper-250">
                <ul class="accordion">
                    <li id="one" class="files"> <a class="active" href="./">全部文件<span>130</span></a>
                    ...
                    <li id="two" class="circle"> <a href="./circle">我的圈子<span>261</span></a></li>
					...
					<div class="tools-left">
						<div class="btn-group btn-group-sm">
						    ...
						    <ul class="dropdown-menu pull-right drop-menu-action fadein">
                                ...
                                <i class="font-icon icon-share"></i>分享</a></li>
