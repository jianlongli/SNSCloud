	...
	<div class="shoolInfo" id="ShowDIV" >
      <div class="shoolcen">
            ...
            <?php echo $this->tag->form(array('session/start', 'class' => 'form-inline')); ?>
               <p><?php echo $this->tag->textField(array('username', 'size' => '30', 'class' => 'sinput', 'id' => 'username', 'placeholder' => '用户名', 'pattern' => '^[a-zA-Z][a-zA-Z0-9-_\.]{5,12}$', 'title' => '用户名必须由6-15位英文或数字组成，且首字母必须为英文')); ?></p>
