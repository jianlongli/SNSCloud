...
<br /><span>-- 用户名必须由6-15位英文或数字组成，且首字母必须为英文</span></div>
            ...
            <div class="Aler1"><div class="Actenr">
				{{ content() }}
            	{{ submit_button('onclick': 'return checkPassword();', 'style':"background:url(../JinSongSiXiao/imge/inserbut.png) no-repeat top left; width:80px; height:36px; border:none; cursor:pointer;  outline: none; font-size: 0;") }}
			</div></div>
			</form>
    	</div>
