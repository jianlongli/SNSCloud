  ...
  //时间转换		
    ...
    <div class="docmidde">
    	...
    	<div class="docMLeft">
            ...
            <div style="position:absolute; left:280px; top:350px; z-index:999; width:600px;color:yellow;hight:100px;" id="xianshi">{{zhuanjiapinglun}}</div>
            ...
            <div class="docBLeft">
                <h4>专家评论</h4>
                <div class="docBLeft1">
                	<ul><input type="hidden" name="file_id" id="file_id" value="{{file_id}}">
                        ...
                        <li><input type="button" value="推荐"  class="leftbotn1" id="tuijian"/>&nbsp;<label id="tujian_count">{{tuijian}}</label>次</li>
                    </ul>
                </div>
                <h4 >相关推荐</h4>
                <div class="docBLeft2">
        	...
        	<div class="doc_Tspq">
                ...
                <ul>
                	<li>
                        ...
                        <input type="hidden" class="Tsp_input" id="file_id" name="file_id" value="{{file_id}}"/></div>
                 ...
                 <div class="vocn" style="display: none;">
                    ...
                    <div class="vconmidde" id="jubu">
                    	...
                    	{% for product in page %}
                          ...
                          <li class="voc_mlikl" id="{{product.video_id}}ok"><input type="button" value="{{product.video_name}}"  class="wy_buys1" onclick="sub('{{product.video_start}}','{{product.video_end}}',{{product.video_id}});" />
                          <input type="button"  value="删除" onclick="del({{product.video_id}});"  class="xizbt1" onMouseOver="this.className='Upxizbt1'" onMouseOut="this.className='Offxizbt1'"/><br /><label>{{product.video_start}}</label>-<label>{{product.video_end}}</label></li>
                           <li class="voc_bottbored"  id="{{product.video_id}}okk">{{product.video_description}}</li>
                         {{qita}}
                        {% endfor %}
