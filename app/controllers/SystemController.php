...
class SystemController extends ControllerBase
{
	 ...
	 * @param number $id
	 */
	public function bak_personalAction( $option = '', $id = 0 ){
	 ...
	 * Invite manage
	 */
	public function bak_inviteAction( $option = '', $id = 0 )
	{
		$allowArr = array( 'update', 'del', 'add');
		$option = in_array($option, $allowArr) ? $option : '';
		$request = $this->request;
	 ...
	 * @param number $id
	 */
	public function bak_memberAction($option = '', $id = 0)
	{
	 ...
	 * Company manage
	 */
	public function bak_companyAction($option = '', $id = 0){
		$allowArr = array( 'edit', 'del', 'add');
		$option = in_array($option, $allowArr) ? $option : '';
		$request = $this->request;
		if ($option == 'edit') {
	 ...
	 * Circle opration
	 */
	public function bak_circleAction($option = '', $id = 0)
	{
	 ...
	 * System setting
	 */
	public function bak_settingAction($option = '', $id = 0)
	{
	 ...
	 * System logs
	 */
	public function bak_logAction($option = '', $id = 0)
	{
