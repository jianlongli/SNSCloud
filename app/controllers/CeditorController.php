...
class CEditorController extends ControllerBase
{
...
//		$HOST_NAME = 'http://192.168.0.102';
	...
	public function editAction(){
		...
		// 查询被复制文件信息
		$cCloudfileManage = CCloudfileManage::findFirst("url='$filename'");
		$createtime = time();
		// 查询被复制文件信息
		$cLocalfileManage = GLocalfileManage::findFirst("fileid = '$cCloudfileManage->fileid'");
		$filePath = $cLocalfileManage->local;
